...
public class Coercions_LocalTimeTest {
    ...
    public void emptyWhenNullValueCoerced() {
        final Optional<LocalTime> opt = Coercions.coerceToLocalTime(null);
    ...
    public void sameObjectWhenLocalDateCoerced() {
        ...
        final Optional<LocalTime> opt = Coercions.coerceToLocalTime(value);
    ...
    public void dateValueIsProperlyCoerced() {
        ...
        final Optional<LocalTime> opt = Coercions.coerceToLocalTime(value);
        OptionalAssertions.assertThat(opt).isPresentAndEqualTo(value.toLocalTime());
    }
    ...
    public void timestampValueIsProperlyCoerced() {
        ...
        final Optional<LocalTime> opt = Coercions.coerceToLocalTime(value);
        OptionalAssertions.assertThat(opt).isPresentAndEqualTo(value.toLocalDateTime().toLocalTime());
    }
    ...
    public void stringValueIsProperlyCoerced() {
        ...
        final Optional<LocalTime> opt = Coercions.coerceToLocalTime(value);
        OptionalAssertions.assertThat(opt).isPresentAndEqualTo(LocalTime.of(10, 0, 30));
    }
